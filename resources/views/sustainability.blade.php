    ...
    <div class="about-us bg-white dark:bg-zinc-950 pt-32 text-zinc-800 dark:text-white">
        ...
        <div class="px-8">
            <div
                ...
                <h1 class="text-center text-2xl font-semibold text-orange-500 dark:text-violet-700 tracking-wide">Sustainability at Keyosk</h1>
                <br>
            ...
            <div
                class="misc-page-container bg-stone-200 dark:bg-zinc-900">
                <h2 class="text-center text-2xl font-semibold text-orange-500 dark:text-violet-700 tracking-wide">Our Actions</h2>
