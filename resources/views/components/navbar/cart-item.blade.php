...
<div {{ $attributes->merge(['class' => 'w-full px-5 flex flex-row gap-5 items-center text-center rounded-lg bg-stone-100 dark:bg-zinc-900 transition-colors duration-500']) }}>
    ...
    <div class="w-full flex flex-col space-y-5">
        ...
        <div class="flex flex-row w-full justify-between items-center">
            <div class="flex flew-row ring-orange-500 dark:ring-violet-700 ring-2 rounded-md">
                <div class="size-7 flex items-center justify-center bg-stone-200 dark:bg-zinc-700 rounded-bl-md rounded-tl-md">
                ...
                <input class="w-10 h-7 px-[0.33rem] flex items-center justify-center bg-white dark:bg-zinc-800 outline-none" value="{{ $productQuantity }}">
                <div class="size-7 flex items-center justify-center bg-stone-200 dark:bg-zinc-700 rounded-br-md rounded-tr-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                </div>
            </div>
            <div class="size-7 flex items-center justify-center ring-orange-500 dark:ring-violet-700 ring-2 rounded-md">
