    ...
    <main class="px-10 pt-32 pb-[32px] w-full h-fit flex justify-center gap-10">
        ...
        @else
            ...
            <section class="w-96 h-fit p-7 mt-[54px] border-2 border-orange-500 dark:border-violet-700 bg-stone-100 dark:bg-zinc-900 rounded-md text-xl" id="totals">
                ...
                <div class="pt-5">
                    <x-util.button href="/cart/checkout" class="bg-transparent ring-2 ring-orange-500 dark:ring-violet-700 text-orange-500 dark:text-violet-700 hover:bg-orange-500 dark:hover:bg-violet-800 hover:text-zinc-800 dark:hover:text-white " type="button">Checkout</x-util.button>
                </div>
            </section>
        @endif
    </main>
