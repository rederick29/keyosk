            ...
            <form class="mt-5" action="{{ route('review.store', $product->id) }}" method="POST">
                ...
                <div class="w-fit flex flex-row-reverse justify-end pb-2">
                    ...
                    <svg class="w-10 h-10  fill-gray-600 peer peer-hover:fill-yellow-400 hover:fill-yellow-400 "
                        viewBox="-210 0 459 873" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M458.752 0L325.504 298.88L0 333.248L243.136 552.384L175.232 872.48L458.752 709.024V0Z" />
                    </svg>
                    <svg class="w-10 h-10 fill-gray-600 peer peer-hover:fill-yellow-400 hover:fill-yellow-400 "
                        viewBox="210 0 459 873" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 0L133.248 298.88L458.752 333.248L215.616 552.384L283.52 872.48L0 709.024V0Z" />
                ...
                <div>
                    ...
                    <x-util.form.input type="text" id="subject" name="subject" maxlength="75"
                        required></x-util.form.input>
                </div>
                <div>
                    <x-util.form.label>Comment</x-util.form.label>
                    <textarea
                        class="block h-32 p-3 text-xl rounded-lg bg-stone-200 dark:bg-zinc-800 w-full ring-0 focus:ring-4 focus:ring-orange-500/50 dark:focus:ring-violet-700/75 focus:outline-hidden transition-shadow duration-500"
                        id="comment" name="comment" required></textarea>
                </div>
                <x-util.button type="button"
                    class="mt-4 rounded-md p-2 px-5 bg-orange-500  dark:bg-violet-700 text-zinc-800  dark:text-white font-semibold hover:bg-orange-600 dark:hover:bg-violet-800 text-lg hover:bg"
                    id="submit" name="submit">Submit</x-util.button>
            </form>
        </div>
