<div class="relative w-full bg-transparent  p-4">
    <!-- Card Background -->
    <svg class="absolute inset-[-2px] w-[calc(100%+4px)] h-[calc(100%+4px)]" viewBox="0 0 204 258" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
    ...
    <div class="relative flex flex-col text-center pb-4">
        ...
        <img src="{{ asset('images/' . $initials . '.png') }}"  class="pt-4">
