<div
    class="w-96 h-fit px-5 py-7 rounded-lg bg-stone-200 dark:bg-zinc-900 hover:ring-4 hover:scale-105 ring-orange-500 dark:ring-violet-700 overflow-hidden transition-shadow transition-transform cursor-default duration-500"
>
