                ...
                <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <select id="searchQuery"
                            class="w-full sm:w-auto p-3 rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300 ease-in-out placeholder-gray-500 box-border">
