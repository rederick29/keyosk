...
<section class="w-full min-h-[70vh] max-h-[70vh] pt-24 flex items-center bg-linear-to-tr from-orange-500 to-red-500 dark:from-violet-500 dark:to-pink-500 relative overflow-hidden" id="image-scroll">
    ...
    <x-util.button type="button" class="w-fit p-2 z-10 bg-stone-200 dark:bg-zinc-800 rounded-md hidden md:flex items-center justify-center absolute top-30 right-7 transition hover:bg-stone-300 dark:hover:bg-zinc-700" id="perspective-switch">
     ...
     <div class="flex-col w-full md:w-fit md:pl-20 h-full items-center justify-center animate-fade hidden" id="two-d-element">
         <x-util.logo width="600" type="div" class="hidden md:block"></x-util.logo>
         <x-util.logo width="300" type="div" class="block md:hidden [&_.mobile]:hidden [&_.desktop]:block"></x-util.logo>
         <x-util.button
             type="a"
             href="/shop"
             class="w-1/3 mt-10 bg-zinc-800 dark:bg-white text-orange-400 dark:text-violet-500 hover:bg-zinc-900 dark:hover:bg-neutral-200 md:self-start"
         >
             Shop now
         </x-util.button>

         <!-- <img class="absolute right-0 rotate-[50deg] scale-125" src="{{asset('storage/images/db/a75_pro_keyboard.png')}}" alt="keyboard" /> -->
         <div class="hidden md:flex flex-col text-scroll text-9xl font-bold absolute right-30 bottom-0">
