...
<div class="relative">
    <div class="p-2 flex flex-row items-center justify-center rounded-md hover:bg-white/5 ring-violet-700 transition-colors duration-300"
        id="cart-icon">
    ...
    <div class="dropdown-hide w-[100vw] md:w-[32rem] h-fit top-24 md:top-12 lg:top-12 right-0" id="cart-dropdown">
        <div class="flex flex-col items-center min-h-[100%] m-4">
            ...
            <div
                class="flex flex-col w-full p-5 mt-0 bg-zinc-900 min-h-[30vh] max-h-[30vh] overflow-y-scroll rounded-xl">
                @if (Auth::check())
                ...
                @else
                    <div class="w-full h-20 mt-24 flex flex-col justify-between items-center">
                        ...
                        <x-util.button class="w-32 h-10 font-bold bg-violet-700 hover:bg-violet-800" type="a"
                            href="/login">Log In</x-util.button>
                    </div>
                @endif
            </div>
            <div class="h-[12px]"></div>
            <x-util.button type="a" href="/"
                class="bg-violet-700 text-white hover:bg-violet-800">Checkout</x-util.button>
            <div class="h-[12px]"></div>
            <x-util.button type="a" href="/cart"
                class="bg-transparent ring-2 ring-violet-700 text-violet-700 hover:bg-violet-800 hover:text-white">View
                cart</x-util.button>
        </div>
    </div>
</div>
