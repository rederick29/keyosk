...
<div class="lg:hidden md:hidden max-w-[40%]">
    ...
    <div class="scale-0 border-2 border-neutral-400 bg-white dark:bg-zinc-900 rounded-sm fixed md:absolute lg:absolute md:rounded-lg lg:rounded-lg shadow-2xl sm:block md:hidden lg:hidden w-[100vw] h-fit top-24 right-0" id="hamburger-dropdown">
