                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-1/3 mt-5 flex flex-col gap-y-5">
                        @foreach($addresses as $address)
                            <div class="w-full h-18 px-5 flex justify-between bg-zinc-900 rounded-md">
...
{{--                        </div>--}}
    ...
    {{--                        </div>--}}
        ...
        <aside class="w-3/5 min-h-full px-14 py-12 bg-stone-100 dark:bg-zinc-900" id="totals">
            ...
            <div class="h-fit max-h-[425px] overflow-y-scroll px-3 py-3 my-7 flex flex-col gap-y-2 bg-zinc-950 rounded-lg">
