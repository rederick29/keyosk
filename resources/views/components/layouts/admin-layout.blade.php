...
@php
    ...
    $statsStyle = $is_stats ? "bg-orange-500 hover:bg-orange-500 dark:bg-violet-900 dark:hover:bg-violet-900" : "bg-stone-200 dark:bg-zinc-900 ring-zinc-600";
    $statsType = $is_stats ? "div" : "a";

    $usersStyle = $is_users ? "bg-orange-500 hover:bg-orange-500 dark:bg-violet-900 dark:hover:bg-violet-900" : "bg-stone-200 dark:bg-zinc-900 ring-zinc-600";
    $usersType = $is_users ? "div" : "a";

    $ordersStyle = $is_orders ? "bg-orange-500 hover:bg-orange-500 dark:bg-violet-900 dark:hover:bg-violet-900" : "bg-stone-200 dark:bg-zinc-900 ring-zinc-600";
    $ordersType = $is_orders ? "div" : "a";

    $productsStyle = $is_products ? "bg-orange-500 hover:bg-orange-500 dark:bg-violet-900 dark:hover:bg-violet-900" : "bg-stone-200 dark:bg-zinc-900 ring-zinc-600";
    $productsType = $is_products ? "div" : "a";

    $imagesStyle = $is_images ? "bg-orange-500 hover:bg-orange-500 dark:bg-violet-900 dark:hover:bg-violet-900" : "bg-stone-200 dark:bg-zinc-900 ring-zinc-600";
...
<x-layouts.min-layout>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="p-2 bg-zinc-700 rounded-md ring-inherit ring-2"
                >
            ...
            <x-util.button
                ...
                class="justify-start {{ $productsStyle }} w-96 py-3 pl-5 rounded-none font-semibold transition-shadow duration-500"
            >
                <div
                    class="p-2 bg-zinc-700 rounded-md ring-inherit ring-2"
                >
            ...
            <x-util.button
                ...
                class="justify-start {{ $imagesStyle }} w-96 py-3 pl-5 rounded-none font-semibold transition-shadow duration-500"
            >
                <div
                    class="p-2 bg-zinc-700 rounded-md shadow-xl ring-inherit ring-2"
                >
