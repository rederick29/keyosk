...
<nav class="flex flex-row fixed justify-between items-center px-5 md:px-5 lg:px-20 min-h-24 min-w-full bg-zinc-900 text-neutral-400 border border-x-0 border-t-0 border-b-4 border-violet-700 shadow-xl">
    {{-- Desktop Links --}}
