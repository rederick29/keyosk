...
<form {{ $attributes->merge(['class' => 'inline-flex']) }}>
    <div class="relative flex flex-row w-full">
        ...
        <input type="search" id="search-bar"
            class="block w-full p-3 h-full ps-10 text-sm outline-none placeholder:text-zinc-800  placeholder:dark:text-white text-zinc-800 dark:text-neutral-100 rounded-lg bg-stone-300 dark:bg-zinc-800 hover:ring hover:ring-orange-500 dark:hover:ring-violet-700/75 focus:border-zinc-700 font-normal transition-all duration-500"
