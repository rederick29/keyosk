                    ...
                    <form class="grid grid-rows-2" method="POST" action="{{ route('cart.store') }}">
                        ...
                        <div class="w-28">
                            ...
                            <div class="flex items-center bg-zinc-800 text-white rounded-md overflow-hidden">
                                ...
                                <input type="number" id="quantity-{{ $product->id }}-input" name="quantity"
                                    min="0" value="1"
                        ...
                        <div class="space-x-5 pt-5">
                            <button type="submit"
                                class=" px-7 py-2 rounded-sm bg-white hover:bg-zinc-200 text-md text-violet-700 text-xl shadow-md ">
                                Add to cart
                            </button>
                    </form>
                    <button
                        class=" px-7 py-2 rounded-sm bg-violet-700 hover:bg-violet-500
                         text-md text-white text-xl shadow-md ">
                        Buy now
                    </button>
                </div>
            </div>
