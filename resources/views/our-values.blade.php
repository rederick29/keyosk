    ...
    <div class="bg-white dark:bg-zinc-950 text-zinc-800 dark:text-white font-sans pt-32">
        ...
        <div class="px-8">
            <div
                ...
                <h1 class="text-center text-2xl font-semibold text-orange-500 dark:text-violet-700">The Keyosk Price Principle</h1>
                <br>
                <p class="text-center mx-auto w-3/4 py-2 leading-relaxed">
                    ...
                    <br><br>
                    Beyond competitive pricing, we stand by durability and dependability, ensuring our products are
                    built to
