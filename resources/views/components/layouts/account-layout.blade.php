        ...
        >
            ...
            <div class="flex absolute bottom-2 left-2">
                ...
                @if (Auth::user()->is_admin)
                    <a href="{{ route('admin.stats') }}" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-hidden focus:ring-2 focus:ring-gray-700 rounded-lg p-1">
