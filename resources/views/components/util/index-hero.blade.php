...
<section class="w-full min-h-[70vh] max-h-[70vh] pt-24 flex items-center bg-linear-to-tr from-orange-500 to-red-500 dark:from-violet-500 dark:to-pink-500 relative overflow-hidden" id="image-scroll">
    ...
    <x-util.button type="button" class="w-fit p-2 z-10 bg-zinc-800 rounded-md flex items-center justify-center absolute top-30 right-7 transition hover:bg-zinc-700" id="perspective-switch">
    ...
    <!-- Left side - Shop Now text (1/4 width) -->
     <div class="flex-col pl-20 h-full items-center justify-center animate-fade hidden" id="two-d-element">
