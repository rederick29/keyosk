...
<div class="bg-green-700 py-32 px-10">
    <div class="flex flex-col mx-5">
        <div class="px-10">
            <img width="600px" class="rounded-sm" src="https://th.bing.com/th/id/R.2dd71b9661e8f903644f7e681f5fa6d6?rik=QGpKKR64kRogrQ&pid=ImgRaw&r=0" alt="Product image">
        </div>
    </div>
</div>

<!-- <div class="bg-gray-100 dark:bg-gray-500 py-8">
<img width="500px" src="https://th.bing.com/th/id/R.2dd71b9661e8f903644f7e681f5fa6d6?rik=QGpKKR64kRogrQ&pid=ImgRaw&r=0" alt="Product image">
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col md:flex-row -mx-4">
        <div class="md:flex-1 px-4">
            <div class="h-[700px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
