    ...
    <main class="pt-[96px] w-full min-h-screen h-full flex justify-center">
        ...
        <aside class="w-1/3 min-h-full px-14 py-12 bg-zinc-900" id="totals">
            ...
            <div class="py-7 mx-2">
                ...
                @else
                    <x-util.button type="a" href="{{ route('checkout.get') }}" class="bg-transparent ring-2 ring-orange-500 dark:ring-violet-700 text-orange-500 dark:text-violet-700 hover:bg-orange-500 dark:hover:bg-violet-800 hover:text-zinc-800 dark:hover:text-white " type="button">Checkout</x-util.button>
                @endif
